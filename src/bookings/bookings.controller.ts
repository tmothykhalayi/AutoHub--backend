...
export class BookingController {
  ...
  @ApiOperation({ summary: 'Create a new booking', description: 'Create a new vehicle booking with the provided details' })
  @ApiBody({ type: CreateBookingDto })
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Booking successfully created' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid booking data' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'User or vehicle not found' })
  @ApiResponse({ status: HttpStatus.CONFLICT, description: 'Vehicle already booked for the selected dates' })
  ...
  @ApiOperation({ summary: 'Get all bookings', description: 'Retrieve all bookings with optional filters' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Return all bookings matching filters' })
  findAll(
  ...
  @Get(':id')
  @Roles(Role.CUSTOMER, Role.ADMIN, Role.STAFF)
  @ApiOperation({ summary: 'Get booking by ID', description: 'Retrieve a specific booking by its ID' })
  ...
  @Patch(':id/cancel')
  @Roles(Role.CUSTOMER, Role.ADMIN, Role.STAFF)
  @ApiOperation({ summary: 'Cancel booking', description: 'Cancel a booking by ID' })
  @ApiParam({ name: 'id', description: 'Booking ID' })
  @ApiBody({ 
    schema: {
      type: 'object',
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Booking successfully cancelled' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Booking not found' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Cannot cancel this booking' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Unauthorized to cancel this booking' })
  cancel(
    @Param('id', ParseIntPipe) id: number,
