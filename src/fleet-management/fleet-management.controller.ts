...
export class FleetManagementController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Create fleet management entry',
    description: 'Create a new fleet management record',
  })
  @ApiBody({ type: CreateFleetManagementDto })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Fleet management record successfully created',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Get all fleet management records',
    description: 'Retrieve all fleet management records',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Return all fleet management records',
  })
  findAll() {
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Get fleet record by ID',
    description: 'Retrieve a specific fleet management record by ID',
  })
  @ApiParam({ name: 'id', description: 'Fleet record ID' })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Return the fleet management record',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Fleet management record not found',
  })
  ...
  @Patch(':id')
  @ApiOperation({
    summary: 'Update fleet record',
    description: 'Update a fleet management record by ID',
  })
  @ApiParam({ name: 'id', description: 'Fleet record ID' })
  @ApiBody({ type: UpdateFleetManagementDto })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Fleet management record successfully updated',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Fleet management record not found',
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Delete fleet record',
    description: 'Delete a fleet management record by ID',
  })
  @ApiParam({ name: 'id', description: 'Fleet record ID' })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Fleet management record successfully deleted',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Fleet management record not found',
