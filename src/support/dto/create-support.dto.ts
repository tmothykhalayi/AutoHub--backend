...
export class CreateSupportDto {
  @ApiProperty({
    description: 'ID of the user creating the support ticket',
    example: 1,
  })
  @IsNotEmpty()
  @IsNumber()
  ...
  @ApiProperty({
    ...
    example: 'I am having trouble booking a vehicle for the weekend.',
  })
  @IsString()
  @MinLength(10)
  @MaxLength(2000)
  ...
  @ApiPropertyOptional({
    ...
    enum: ['general', 'technical', 'billing', 'account', 'feature-request'],
    example: 'technical',
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    example: 'Issue with booking confirmation',
  })
  @IsNotEmpty()
  @IsString()
  subject: string;
